...
write.csv(NECall,"data/created-data/EastBridge_PTdata_2018-2023wy.csv")


NPB22<-read.csv("data/PhelpsBridge_PTdata_2018-2022wy.csv")
NPB23<-read.csv("data/Phelps_Levelogger_2023.csv",skip=11)
NPB23<-NPB23[,c(1,2,4,5)]
NPB23$X<-1
NPB23$CONDUCTIVITY<-NA
NPB23$WSE_ft<-NPB23$LEVEL+9.99
NPBall<-rbind(NPB22,NPB23)
write.csv(NPBall,"data/created-data/PhelpsBridge_PTdata_2018-2023wy.csv")
...
write.csv(NVBall,"data/created-data/Veneco_Bridge_PTdata_2018-2023wy.csv")
